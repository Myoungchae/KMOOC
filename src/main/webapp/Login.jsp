...
<head>
    ...
    <style>
        ...
        #logindiv{width: 700px; height: 600px; position: relative; top: 100px; left: 495px; padding: 30px;}
        #loginform{font-size: 30px; text-align: center;}
        #inputEmaillog{width: 360px; height: 30px; margin-left: 80px; margin-bottom: 30px; margin-top: 70px;}
        #inputPasswordlog{width: 360px; height: 30px; margin-left: 26px; margin-bottom: 30px;}
        #loginbtn{width: 25%; height: 50px; font-size: 25px; margin-top: 30px; background-color:#5B97E1; border: 1px solid #5B97E1; color: white;}
        ...
        hr{width: 1230px; margin-top: -20px;}
        #f4{width: 1000px; height: 90px; color: #FFFFFF; position: relative; top: -520px; left: 220px;}
        #f4>a{display: inline-block; color: #FFFFFF; text-decoration: none; margin-left: 10px;}
        #bluep2{color: #79a9ff;}
        #f5{width: 500px; height: 90px; position: relative; top: -590px; left: 850px;}
    ...
    <div id="wrapper" action="LoginProc.do">
        ...
        <div id="logindiv">
            ...
            <form id="loginform" method="post" action="LoginProc.do">
                ...
                <input type="email" id="inputEmaillog" name="email">
                </div>
                <div id="loginpwd">
                <label for="inputPassword4">Password</label>
                <input type="password" id="inputPasswordlog" name="pwd">
                </div>
                <div id="logind1">
                <input type="submit" value="로그인" id="loginbtn" class="btn btn-primary w-30">
                </div>
            </form>
        </div>
